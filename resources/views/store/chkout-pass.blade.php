    ...
    <div class="flex items-center justify-center min-h-screen bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
        <div class="w-full max-w-2xl p-4 bg-white shadow-2xl dark:bg-gray-900 sm:p-10 sm:rounded-3xl">
            <div class="text-center">
                ...
                <h1 class="text-4xl font-extrabold text-green-700 dark:text-green-400">Orden creada!</h1>
                <p class="mt-4 text-lg text-gray-800 dark:text-gray-300">
                    Gracias por tu compra.
                </p>
                <p class="mt-6 text-xl text-blue-600 dark:text-blue-400">
                    Tu orden se encuentra en la sección <a href="{{ route('my-orders') }}" class="font-bold text-indigo-700 dark:text-indigo-400 underline hover:text-indio-verde dark:hover:text-white">Mis órdenes</a>, pero todavía falta que registres el comprobante de tu transferencia.
                </p>
