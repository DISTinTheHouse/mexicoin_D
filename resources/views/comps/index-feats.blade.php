<!-- features -->
    <div class="">
        <div class="grid grid-cols-1 gap-3 mx-auto justify-center">
            <a href="{{ route('membership') }}" class="border border-emerald-700 rounded-sm px-1 py-3 flex justify-center items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-xs lg:text-base xl:text-lg">Con membresía pro</p>
                </div>
            </a>
            ...
            <a href="{{ route('contact') }}" class="border border-emerald-700 rounded-sm px-1 py-3 flex justify-center items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-xs lg:text-base xl:text-lg">Para nuestros clientes</p>
                </div>
            </a>
        </div>
    </div>
