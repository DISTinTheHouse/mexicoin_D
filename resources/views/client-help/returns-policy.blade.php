...
<section class="bg-white py-12 px-6 md:px-16">
    <div class="max-w-4xl mx-auto">
        <h1 class="text-3xl font-bold text-[#1C3144] mb-6 text-center">Política de Devoluciones</h1>
        ...
        <div id="accordion-devoluciones" data-accordion="collapse" class="space-y-3">
            ...
            <h2 id="accordion-devoluciones-heading-1">
                <button type="button" class="flex justify-between items-center w-full p-5 font-medium text-left text-gray-700 border border-gray-200 rounded-lg hover:bg-gray-50 focus:ring-2 focus:ring-[#7EA16B]" 
            ...
            <div id="accordion-devoluciones-body-3" class="hidden" aria-labelledby="accordion-devoluciones-heading-3">
                <div class="p-5 border border-t-0 border-gray-200 rounded-b-lg">
                    <ol class="list-decimal list-inside text-gray-600 space-y-1">
                        <li>Envíanos un correo a <a href="mailto:contacto@inversionesnumismaticas.com" class="text-[#1C3144] font-medium hover:underline">contacto@inversionesnumismaticas.com</a> con el número de pedido y una descripción del motivo de la devolución.</li>
        ...
        <div class="mt-8 text-center">
            <a href="{{ url('/') }}" class="inline-block bg-[#7EA16B] text-white px-6 py-3 rounded-lg hover:bg-[#596F62] transition-colors">
                Volver al inicio
            </a>
        </div>
    </div>
